...
exports.default = function (projectConfig, projectToolsConfig) {
  ...
  var dynamicMiddleware = function dynamicMiddleware(originalUrl, headers, send, redirect) {
    ...
    var memoryHistory = (0, _createMemoryHistory2.default)(originalUrl);
    var store = (0, _create2.default)(middleware, memoryHistory);
    ...
    return new _promise2.default(function (resolve) {
      (0, _reactRouter.match)(routes, originalUrl, store, memoryHistory, function (error, redirectLocation, renderProps) {
        ...
        if (redirectLocation) {
          ...
          rootServerComponent(store, renderProps, config.providers).then(function (root) {
    ...
    case 'express':
      {
        return function (req, res) {
          dynamicMiddleware(req.originalUrl, req.headers, function (status, body) {
